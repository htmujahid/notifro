...
<body style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:32px 16px;color:#111;">
  ...
  <p style="color:#555;">Hi ${name}, use the code below to complete your sign in.</p>
  ...
  <p style="color:#999;font-size:13px;">This code expires in 3 minutes. If you didn't try to sign in, you can safely ignore this email.</p>
</body>
</html>`,
    text: `Hi ${name},\n\nYour verification code is: ${otp}\n\nThis code expires in 3 minutes. If you didn't try to sign in, ignore this email.`,
  })
}
