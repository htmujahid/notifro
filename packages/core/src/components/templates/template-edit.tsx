...
import { HistoryIcon, EyeIcon, SaveIcon, RotateCcwIcon } from "lucide-react"
import { Button } from "@workspace/ui/components/button"
import { useTemplate, useCreateTemplate, useUpdateTemplate, useDeleteTemplate, useRenderPreview, useTemplateVersions, useRestoreVersion } from "@workspace/core/hooks/templates"
...
function VersionRow({ v, onRestore, restoring }: VersionRowProps) {
  return (
