  ...
  return (
    <div className="flex flex-col items-center gap-6 text-center">
      {status === "pending" && (
        <>
          <div className="flex size-14 items-center justify-center rounded-full bg-muted">
            <svg className="size-6 animate-spin text-muted-foreground" fill="none" viewBox="0 0 24 24">
      ...
      {status === "error" && (
        <>
          <div className="flex size-14 items-center justify-center rounded-full bg-muted">
            <svg className="size-7 text-destructive" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
