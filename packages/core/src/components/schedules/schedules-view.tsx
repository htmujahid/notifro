...
const SCHEDULES = [
  { id: 1, name: "Weekly digest", cron: "0 9 * * 1", description: "Every Monday at 9 AM", channel: "Email", audience: "All users", active: true, nextRun: "Jun 23, 09:00" },
  { id: 2, name: "Daily health check", cron: "0 8 * * *", description: "Every day at 8 AM", channel: "Slack", audience: "#ops-team", active: true, nextRun: "Jun 20, 08:00" },
  { id: 3, name: "Monthly invoice reminder", cron: "0 10 1 * *", description: "1st of every month at 10 AM", channel: "Email", audience: "Subscribed users", active: false, nextRun: "Jul 1, 10:00" },
  { id: 4, name: "Subscription expiry alert", cron: "0 9 * * *", description: "Daily for users expiring in 7 days", channel: "Push", audience: "Expiring users", active: true, nextRun: "Jun 20, 09:00" },
  { id: 5, name: "Backup webhook ping", cron: "*/15 * * * *", description: "Every 15 minutes", channel: "Webhook", audience: "api.internal/health", active: false, nextRun: "Paused" },
]
