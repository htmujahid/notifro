...
const summaryRoute = createRoute({
  ...
  responses: {
    200: { content: { 'application/json': { schema: SummaryResponseSchema } }, description: 'Analytics summary' },
  },
})
...
const timeseriesRoute = createRoute({
  ...
  responses: {
    200: { content: { 'application/json': { schema: TimeseriesResponseSchema } }, description: 'Analytics timeseries' },
  },
})
...
const channelsRoute = createRoute({
  ...
  responses: {
    200: { content: { 'application/json': { schema: ChannelsResponseSchema } }, description: 'Per-channel analytics' },
  },
})
...
const topTopicsRoute = createRoute({
  ...
  request: { query: rangeQuerySchema },
  responses: {
    200: { content: { 'application/json': { schema: TopTopicsResponseSchema } }, description: 'Top topics by send volume' },
  },
})
