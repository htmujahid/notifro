...
The Renderical Android app — the dashboard delivered as a native Android application.
...
- [`@renderical/views`](../../packages/views) — shared pages (consumes `./routes/android`)
